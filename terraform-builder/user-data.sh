...
# Install newer rclone. Ubuntu packages are outdated
...
rclone copy /mnt/src/chromium-webview chromium-webview --buffer-size 1300Mi --fast-list --human-readable --metadata -L --progress --multi-thread-streams=$(nproc)
